...
> **Category:** Security & Compliance · **Skill:** `threat-modeling` · **OpenSpec lifecycle skill**
...
- Starting work that requires threat modeling as a deliberate, documented step
...
- Threats mitigated vs accepted
- Findings caught pre-production
...
- `templates/threat-model.md` — Threat Model
- `templates/dfd.md` — Data-Flow Diagram
