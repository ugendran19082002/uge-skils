...
> **Category:** Security & Compliance · **Skill:** `access-control-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires access control design as a deliberate, documented step
...
- `templates/access-model.md` — Access Control Model
- `templates/rbac-matrix.md` — Role/Permission Matrix
