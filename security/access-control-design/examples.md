# Access Control Design — Worked Examples

Realistic, end-to-end walkthroughs of the `access-control-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Access Control Design on a greenfield feature

**Context.** A team is starting new work and needs access control design done properly the first time.
...
## Example 2: Applying Access Control Design to an existing system

**Context.** An established system needs access control design retrofitted to reduce risk.
