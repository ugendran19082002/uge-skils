...
Design secure authentication, JWT, OAuth, sessions, MFA — applied to: SaaS with login, payments and search

## Problem Statement

Based on the request: "SaaS with login, payments and search", this skill addresses the need to properly design and implement **Authentication Design** for the saas project "hybridtest".
...
See `checklist.md` for the full list of anti-patterns specific to `authentication-design`.

---
*Generated by ugendran — OpenSpec Skill: `authentication-design`*
