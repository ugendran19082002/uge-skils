# Product Analytics — Worked Examples

Realistic, end-to-end walkthroughs of the `product-analytics` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Product Analytics on a greenfield feature

**Context.** A team is starting new work and needs product analytics done properly the first time.
...
## Example 2: Applying Product Analytics to an existing system

**Context.** An established system needs product analytics retrofitted to reduce risk.
