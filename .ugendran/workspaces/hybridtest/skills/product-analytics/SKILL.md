...
> **Category:** Product · **Skill:** `product-analytics` · **OpenSpec lifecycle skill**
...
- Starting work that requires product analytics as a deliberate, documented step
...
- % of events conforming to the tracking plan
- Time-to-answer for product questions
...
- `templates/tracking-plan.md` — Tracking Plan
- `templates/metric-definitions.md` — Metric Definitions
