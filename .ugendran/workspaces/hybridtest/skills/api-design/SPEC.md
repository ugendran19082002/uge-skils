...
Design clear, consistent, evolvable REST/GraphQL/gRPC APIs — applied to: SaaS with login, payments and search

## Problem Statement

Based on the request: "SaaS with login, payments and search", this skill addresses the need to properly design and implement **Api Design** for the saas project "hybridtest".
...
See `checklist.md` for the full list of anti-patterns specific to `api-design`.

---
*Generated by ugendran — OpenSpec Skill: `api-design`*
