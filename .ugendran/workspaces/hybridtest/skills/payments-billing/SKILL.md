...
> **Category:** Backend · **Skill:** `payments-billing` · **OpenSpec lifecycle skill**
...
- Starting work that requires payments & billing as a deliberate, documented step
...
- Involuntary churn from dunning
...
- `templates/billing-design.md` — Billing Design
- `templates/reconciliation-plan.md` — Reconciliation Plan
