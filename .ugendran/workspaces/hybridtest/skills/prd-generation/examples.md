# PRD Generation — Worked Examples

Realistic, end-to-end walkthroughs of the `prd-generation` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying PRD Generation on a greenfield feature

**Context.** A team is starting new work and needs prd generation done properly the first time.
...
## Example 2: Applying PRD Generation to an existing system

**Context.** An established system needs prd generation retrofitted to reduce risk.
