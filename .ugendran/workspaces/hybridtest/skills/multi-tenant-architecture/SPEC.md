...
Isolate and scale many tenants safely — applied to: SaaS with login, payments and search

## Problem Statement

Based on the request: "SaaS with login, payments and search", this skill addresses the need to properly design and implement **Multi Tenant Architecture** for the saas project "hybridtest".
...
See `checklist.md` for the full list of anti-patterns specific to `multi-tenant-architecture`.

---
*Generated by ugendran — OpenSpec Skill: `multi-tenant-architecture`*
