...
Size market, map competitors, validate demand — applied to: SaaS with login, payments and search

## Problem Statement

Based on the request: "SaaS with login, payments and search", this skill addresses the need to properly design and implement **Market Research** for the saas project "hybridtest".
...
See `checklist.md` for the full list of anti-patterns specific to `market-research`.

---
*Generated by ugendran — OpenSpec Skill: `market-research`*
