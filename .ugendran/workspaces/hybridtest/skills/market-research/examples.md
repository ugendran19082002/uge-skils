# Market Research — Worked Examples

Realistic, end-to-end walkthroughs of the `market-research` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Market Research on a greenfield feature

**Context.** A team is starting new work and needs market research done properly the first time.
...
## Example 2: Applying Market Research to an existing system

**Context.** An established system needs market research retrofitted to reduce risk.
