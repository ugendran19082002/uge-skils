# End-to-End Testing — Worked Examples

Realistic, end-to-end walkthroughs of the `e2e-testing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying End-to-End Testing on a greenfield feature

**Context.** A team is starting new work and needs end-to-end testing done properly the first time.
...
## Example 2: Applying End-to-End Testing to an existing system

**Context.** An established system needs end-to-end testing retrofitted to reduce risk.
