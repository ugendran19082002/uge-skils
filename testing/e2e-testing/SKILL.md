...
> **Category:** Testing & Quality · **Skill:** `e2e-testing` · **OpenSpec lifecycle skill**
...
- Starting work that requires end-to-end testing as a deliberate, documented step
...
- `templates/e2e-plan.md` — E2E Test Plan
- `templates/journey-map.md` — Critical Journey Map
