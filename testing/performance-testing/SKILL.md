...
> **Category:** Testing & Quality · **Skill:** `performance-testing` · **OpenSpec lifecycle skill**
...
- Starting work that requires performance testing as a deliberate, documented step
...
- `templates/perf-test-plan.md` — Performance Test Plan
- `templates/workload-model.md` — Workload Model
