# Performance Testing — Worked Examples

Realistic, end-to-end walkthroughs of the `performance-testing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Performance Testing on a greenfield feature

**Context.** A team is starting new work and needs performance testing done properly the first time.
...
## Example 2: Applying Performance Testing to an existing system

**Context.** An established system needs performance testing retrofitted to reduce risk.
