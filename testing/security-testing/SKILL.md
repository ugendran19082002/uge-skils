...
> **Category:** Testing & Quality · **Skill:** `security-testing` · **OpenSpec lifecycle skill**
...
- Starting work that requires security testing as a deliberate, documented step
...
- `templates/sec-test-plan.md` — Security Test Plan
- `templates/findings-report.md` — Findings Report
