# Security Testing — Worked Examples

Realistic, end-to-end walkthroughs of the `security-testing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Security Testing on a greenfield feature

**Context.** A team is starting new work and needs security testing done properly the first time.
...
## Example 2: Applying Security Testing to an existing system

**Context.** An established system needs security testing retrofitted to reduce risk.
