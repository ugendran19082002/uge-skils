# Integration Testing — Worked Examples

Realistic, end-to-end walkthroughs of the `integration-testing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Integration Testing on a greenfield feature

**Context.** A team is starting new work and needs integration testing done properly the first time.
...
## Example 2: Applying Integration Testing to an existing system

**Context.** An established system needs integration testing retrofitted to reduce risk.
