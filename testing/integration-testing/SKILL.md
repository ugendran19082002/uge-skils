...
> **Category:** Testing & Quality · **Skill:** `integration-testing` · **OpenSpec lifecycle skill**
...
- Starting work that requires integration testing as a deliberate, documented step
...
- `templates/integration-plan.md` — Integration Test Plan
- `templates/test-harness.md` — Test Harness
