...
> **Category:** Testing & Quality · **Skill:** `contract-testing` · **OpenSpec lifecycle skill**
...
- Starting work that requires contract testing as a deliberate, documented step
...
- Breaking changes caught pre-deploy
- Contract coverage of integrations
- End-to-end test reduction
- Can-i-deploy gate pass rate
...
- `templates/contract.md` — Consumer-Driven Contract
- `templates/verification-plan.md` — Provider Verification Plan
