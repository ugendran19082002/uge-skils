# Contract Testing — Worked Examples

Realistic, end-to-end walkthroughs of the `contract-testing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Contract Testing on a greenfield feature

**Context.** A team is starting new work and needs contract testing done properly the first time.
...
## Example 2: Applying Contract Testing to an existing system

**Context.** An established system needs contract testing retrofitted to reduce risk.
