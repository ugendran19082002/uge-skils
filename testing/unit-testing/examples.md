# Unit Testing — Worked Examples

Realistic, end-to-end walkthroughs of the `unit-testing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Unit Testing on a greenfield feature

**Context.** A team is starting new work and needs unit testing done properly the first time.
...
## Example 2: Applying Unit Testing to an existing system

**Context.** An established system needs unit testing retrofitted to reduce risk.
