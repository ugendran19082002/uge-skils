...
> **Category:** Testing & Quality · **Skill:** `unit-testing` · **OpenSpec lifecycle skill**
...
- Starting work that requires unit testing as a deliberate, documented step
...
- `templates/unit-test-guide.md` — Unit Test Guidelines
- `templates/test-case.md` — Test Case
