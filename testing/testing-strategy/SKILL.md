...
> **Category:** Testing & Quality · **Skill:** `testing-strategy` · **OpenSpec lifecycle skill**
...
- Starting work that requires testing strategy as a deliberate, documented step
...
- `templates/test-strategy.md` — Test Strategy
- `templates/quality-gates.md` — Quality Gates
