# Payments & Billing — Worked Examples

Realistic, end-to-end walkthroughs of the `payments-billing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Payments & Billing on a greenfield feature

**Context.** A team is starting new work and needs payments & billing done properly the first time.
...
## Example 2: Applying Payments & Billing to an existing system

**Context.** An established system needs payments & billing retrofitted to reduce risk.
