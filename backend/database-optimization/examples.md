# Database Optimization — Worked Examples

Realistic, end-to-end walkthroughs of the `database-optimization` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Database Optimization on a greenfield feature

**Context.** A team is starting new work and needs database optimization done properly the first time.
...
## Example 2: Applying Database Optimization to an existing system

**Context.** An established system needs database optimization retrofitted to reduce risk.
