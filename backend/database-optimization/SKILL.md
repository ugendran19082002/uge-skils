...
> **Category:** Backend · **Skill:** `database-optimization` · **OpenSpec lifecycle skill**
...
- Starting work that requires database optimization as a deliberate, documented step
...
- `templates/db-tuning.md` — DB Tuning Plan
- `templates/query-analysis.md` — Query Analysis
