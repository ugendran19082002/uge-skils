...
> **Category:** Backend · **Skill:** `api-contract-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires api contract design as a deliberate, documented step
...
- `templates/contract-spec.md` — API Contract
- `templates/compat-policy.md` — Compatibility Policy
