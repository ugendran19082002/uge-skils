...
> **Category:** Backend · **Skill:** `caching-strategy` · **OpenSpec lifecycle skill**
...
- Starting work that requires caching strategy as a deliberate, documented step
...
- `templates/caching-strategy.md` — Caching Strategy
- `templates/invalidation-plan.md` — Invalidation Plan
