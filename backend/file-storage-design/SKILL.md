...
> **Category:** Backend · **Skill:** `file-storage-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires file storage design as a deliberate, documented step
...
- `templates/storage-design.md` — File Storage Design
- `templates/upload-flow.md` — Upload/Download Flow
