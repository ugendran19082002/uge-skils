...
> **Category:** Backend · **Skill:** `authentication-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires authentication design as a deliberate, documented step
...
- `templates/authn-design.md` — Authentication Design
- `templates/token-policy.md` — Token & Session Policy
