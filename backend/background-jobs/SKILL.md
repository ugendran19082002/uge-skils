...
> **Category:** Backend · **Skill:** `background-jobs` · **OpenSpec lifecycle skill**
...
- Starting work that requires background jobs as a deliberate, documented step
...
- `templates/job-design.md` — Background Job Design
- `templates/queue-topology.md` — Queue Topology
