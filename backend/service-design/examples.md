# Service Design — Worked Examples

Realistic, end-to-end walkthroughs of the `service-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Service Design on a greenfield feature

**Context.** A team is starting new work and needs service design done properly the first time.
...
## Example 2: Applying Service Design to an existing system

**Context.** An established system needs service design retrofitted to reduce risk.
