# Monitoring & Alerting — Worked Examples

Realistic, end-to-end walkthroughs of the `monitoring-alerting` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Monitoring & Alerting on a greenfield feature

**Context.** A team is starting new work and needs monitoring & alerting done properly the first time.
...
## Example 2: Applying Monitoring & Alerting to an existing system

**Context.** An established system needs monitoring & alerting retrofitted to reduce risk.
