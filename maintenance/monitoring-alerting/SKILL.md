...
> **Category:** Maintenance & Operations · **Skill:** `monitoring-alerting` · **OpenSpec lifecycle skill**
...
- Starting work that requires monitoring & alerting as a deliberate, documented step
...
- `templates/alerting-plan.md` — Alerting Plan
- `templates/alert-catalog.md` — Alert Catalog
