...
> **Category:** Maintenance & Operations · **Skill:** `bug-investigation` · **OpenSpec lifecycle skill**
...
- Starting work that requires bug investigation as a deliberate, documented step
...
- `templates/bug-report.md` — Bug Investigation Report
- `templates/rca.md` — Root-Cause Analysis
