# Bug Investigation — Worked Examples

Realistic, end-to-end walkthroughs of the `bug-investigation` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Bug Investigation on a greenfield feature

**Context.** A team is starting new work and needs bug investigation done properly the first time.
...
## Example 2: Applying Bug Investigation to an existing system

**Context.** An established system needs bug investigation retrofitted to reduce risk.
