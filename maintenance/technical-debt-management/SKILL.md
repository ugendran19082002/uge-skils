...
> **Category:** Maintenance & Operations · **Skill:** `technical-debt-management` · **OpenSpec lifecycle skill**
...
- Starting work that requires technical debt management as a deliberate, documented step
...
- % capacity on paydown
- Defect density in high-debt areas
...
- `templates/debt-register.md` — Technical Debt Register
- `templates/paydown-plan.md` — Paydown Plan
