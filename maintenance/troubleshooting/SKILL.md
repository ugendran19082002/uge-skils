...
> **Category:** Maintenance & Operations · **Skill:** `troubleshooting` · **OpenSpec lifecycle skill**
...
- Starting work that requires troubleshooting as a deliberate, documented step
...
- `templates/troubleshooting-guide.md` — Troubleshooting Guide
- `templates/diagnosis-log.md` — Diagnosis Log
