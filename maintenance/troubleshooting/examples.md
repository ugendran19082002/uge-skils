# Troubleshooting — Worked Examples

Realistic, end-to-end walkthroughs of the `troubleshooting` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Troubleshooting on a greenfield feature

**Context.** A team is starting new work and needs troubleshooting done properly the first time.
...
## Example 2: Applying Troubleshooting to an existing system

**Context.** An established system needs troubleshooting retrofitted to reduce risk.
