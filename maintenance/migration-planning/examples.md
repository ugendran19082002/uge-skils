# Migration Planning — Worked Examples

Realistic, end-to-end walkthroughs of the `migration-planning` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Migration Planning on a greenfield feature

**Context.** A team is starting new work and needs migration planning done properly the first time.
...
## Example 2: Applying Migration Planning to an existing system

**Context.** An established system needs migration planning retrofitted to reduce risk.
