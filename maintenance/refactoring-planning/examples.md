# Refactoring Planning — Worked Examples

Realistic, end-to-end walkthroughs of the `refactoring-planning` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Refactoring Planning on a greenfield feature

**Context.** A team is starting new work and needs refactoring planning done properly the first time.
...
## Example 2: Applying Refactoring Planning to an existing system

**Context.** An established system needs refactoring planning retrofitted to reduce risk.
