...
> **Category:** Maintenance & Operations · **Skill:** `refactoring-planning` · **OpenSpec lifecycle skill**
...
- Starting work that requires refactoring planning as a deliberate, documented step
...
- Defect rate in refactored areas
- Change lead time
...
- `templates/refactor-plan.md` — Refactoring Plan
- `templates/hotspot-analysis.md` — Hotspot Analysis
