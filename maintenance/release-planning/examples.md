# Release Planning — Worked Examples

Realistic, end-to-end walkthroughs of the `release-planning` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Release Planning on a greenfield feature

**Context.** A team is starting new work and needs release planning done properly the first time.
...
## Example 2: Applying Release Planning to an existing system

**Context.** An established system needs release planning retrofitted to reduce risk.
