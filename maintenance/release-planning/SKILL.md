...
> **Category:** Maintenance & Operations · **Skill:** `release-planning` · **OpenSpec lifecycle skill**
...
- Starting work that requires release planning as a deliberate, documented step
...
- `templates/release-plan.md` — Release Plan
- `templates/release-checklist.md` — Release Checklist
