# Documentation Generator — Worked Examples

Realistic, end-to-end walkthroughs of the `documentation-generator` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Documentation Generator on a greenfield feature

**Context.** A team is starting new work and needs documentation generator done properly the first time.
...
## Example 2: Applying Documentation Generator to an existing system

**Context.** An established system needs documentation generator retrofitted to reduce risk.
