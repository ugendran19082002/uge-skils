# Incident Response — Worked Examples

Realistic, end-to-end walkthroughs of the `incident-response` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Incident Response on a greenfield feature

**Context.** A team is starting new work and needs incident response done properly the first time.
...
## Example 2: Applying Incident Response to an existing system

**Context.** An established system needs incident response retrofitted to reduce risk.
