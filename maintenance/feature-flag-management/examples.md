# Feature Flag Management — Worked Examples

Realistic, end-to-end walkthroughs of the `feature-flag-management` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Feature Flag Management on a greenfield feature

**Context.** A team is starting new work and needs feature flag management done properly the first time.
...
## Example 2: Applying Feature Flag Management to an existing system

**Context.** An established system needs feature flag management retrofitted to reduce risk.
