...
> **Category:** DevOps & Platform · **Skill:** `docker-architecture` · **OpenSpec lifecycle skill**
...
- Starting work that requires docker architecture as a deliberate, documented step
...
- `templates/dockerfile-standards.md` — Dockerfile Standards
- `templates/image-policy.md` — Image Policy
