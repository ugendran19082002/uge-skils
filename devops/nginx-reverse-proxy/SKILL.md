...
> **Category:** DevOps & Platform · **Skill:** `nginx-reverse-proxy` · **OpenSpec lifecycle skill**
...
- Starting work that requires nginx reverse proxy as a deliberate, documented step
...
- `templates/nginx-config.md` — Nginx Configuration
- `templates/proxy-policy.md` — Proxy Policy
