...
> **Category:** DevOps & Platform · **Skill:** `infrastructure-as-code` · **OpenSpec lifecycle skill**
...
- Starting work that requires infrastructure as code as a deliberate, documented step
...
- `templates/iac-standards.md` — IaC Standards
- `templates/module-spec.md` — Module Spec
