...
> **Category:** DevOps & Platform · **Skill:** `secrets-management` · **OpenSpec lifecycle skill**
...
- Starting work that requires secrets management as a deliberate, documented step
...
- `templates/secrets-policy.md` — Secrets Policy
- `templates/rotation-plan.md` — Rotation Plan
