# Observability Design — Worked Examples

Realistic, end-to-end walkthroughs of the `observability-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Observability Design on a greenfield feature

**Context.** A team is starting new work and needs observability design done properly the first time.
...
## Example 2: Applying Observability Design to an existing system

**Context.** An established system needs observability design retrofitted to reduce risk.
