...
> **Category:** DevOps & Platform · **Skill:** `observability-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires observability design as a deliberate, documented step
...
- `templates/observability-design.md` — Observability Design
- `templates/slo-spec.md` — SLI/SLO Spec
