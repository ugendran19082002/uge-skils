...
> **Category:** DevOps & Platform · **Skill:** `ci-cd-pipeline` · **OpenSpec lifecycle skill**
...
- Starting work that requires ci/cd pipeline as a deliberate, documented step
...
- `templates/pipeline-design.md` — Pipeline Design
- `templates/deploy-strategy.md` — Deployment Strategy
