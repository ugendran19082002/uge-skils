...
> **Category:** DevOps & Platform · **Skill:** `kubernetes-planning` · **OpenSpec lifecycle skill**
...
- Starting work that requires kubernetes planning as a deliberate, documented step
...
- `templates/k8s-plan.md` — Kubernetes Plan
- `templates/workload-spec.md` — Workload Spec
