# SSL/TLS Management — Worked Examples

Realistic, end-to-end walkthroughs of the `ssl-management` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying SSL/TLS Management on a greenfield feature

**Context.** A team is starting new work and needs ssl/tls management done properly the first time.
...
## Example 2: Applying SSL/TLS Management to an existing system

**Context.** An established system needs ssl/tls management retrofitted to reduce risk.
