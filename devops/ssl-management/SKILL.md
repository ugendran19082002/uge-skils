...
> **Category:** DevOps & Platform · **Skill:** `ssl-management` · **OpenSpec lifecycle skill**
...
- Starting work that requires ssl/tls management as a deliberate, documented step
...
- `templates/tls-policy.md` — TLS Policy
- `templates/cert-inventory.md` — Certificate Inventory
