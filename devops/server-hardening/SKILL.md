...
> **Category:** DevOps & Platform · **Skill:** `server-hardening` · **OpenSpec lifecycle skill**
...
- Starting work that requires server hardening as a deliberate, documented step
...
- `templates/hardening-baseline.md` — Hardening Baseline
- `templates/cis-checklist.md` — CIS Checklist
