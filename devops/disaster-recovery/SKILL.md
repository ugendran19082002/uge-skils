...
> **Category:** DevOps & Platform · **Skill:** `disaster-recovery` · **OpenSpec lifecycle skill**
...
- Starting work that requires disaster recovery as a deliberate, documented step
...
- `templates/dr-plan.md` — Disaster Recovery Plan
- `templates/dr-runbook.md` — DR Runbook
