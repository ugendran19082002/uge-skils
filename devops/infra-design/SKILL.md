...
> **Category:** DevOps & Platform · **Skill:** `infra-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires infrastructure design as a deliberate, documented step
...
- `templates/infra-design.md` — Infrastructure Design
- `templates/network-topology.md` — Network Topology
