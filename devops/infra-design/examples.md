# Infrastructure Design — Worked Examples

Realistic, end-to-end walkthroughs of the `infra-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Infrastructure Design on a greenfield feature

**Context.** A team is starting new work and needs infrastructure design done properly the first time.
...
## Example 2: Applying Infrastructure Design to an existing system

**Context.** An established system needs infrastructure design retrofitted to reduce risk.
