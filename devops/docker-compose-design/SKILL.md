...
> **Category:** DevOps & Platform · **Skill:** `docker-compose-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires docker compose design as a deliberate, documented step
...
- `templates/compose-design.md` — Compose Stack Design
- `templates/compose-standards.md` — Compose Standards
