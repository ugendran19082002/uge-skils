# Docker Compose Design — Worked Examples

Realistic, end-to-end walkthroughs of the `docker-compose-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Docker Compose Design on a greenfield feature

**Context.** A team is starting new work and needs docker compose design done properly the first time.
...
## Example 2: Applying Docker Compose Design to an existing system

**Context.** An established system needs docker compose design retrofitted to reduce risk.
