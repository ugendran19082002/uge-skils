# Component Design — Worked Examples

Realistic, end-to-end walkthroughs of the `component-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Component Design on a greenfield feature

**Context.** A team is starting new work and needs component design done properly the first time.
...
## Example 2: Applying Component Design to an existing system

**Context.** An established system needs component design retrofitted to reduce risk.
