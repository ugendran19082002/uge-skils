...
> **Category:** Frontend · **Skill:** `component-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires component design as a deliberate, documented step
...
- `templates/component-spec.md` — Component Spec
- `templates/component-api.md` — Component API
