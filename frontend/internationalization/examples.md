# Internationalization & Localization — Worked Examples

Realistic, end-to-end walkthroughs of the `internationalization` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Internationalization & Localization on a greenfield feature

**Context.** A team is starting new work and needs internationalization & localization done properly the first time.
...
## Example 2: Applying Internationalization & Localization to an existing system

**Context.** An established system needs internationalization & localization retrofitted to reduce risk.
