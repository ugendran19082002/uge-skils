...
> **Category:** Frontend · **Skill:** `state-management` · **OpenSpec lifecycle skill**
...
- Starting work that requires state management as a deliberate, documented step
...
- `templates/state-architecture.md` — State Architecture
- `templates/state-map.md` — State Ownership Map
