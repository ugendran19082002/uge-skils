# Frontend Testing — Worked Examples

Realistic, end-to-end walkthroughs of the `frontend-testing` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Frontend Testing on a greenfield feature

**Context.** A team is starting new work and needs frontend testing done properly the first time.
...
## Example 2: Applying Frontend Testing to an existing system

**Context.** An established system needs frontend testing retrofitted to reduce risk.
