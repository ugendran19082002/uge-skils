...
> **Category:** Frontend · **Skill:** `frontend-testing` · **OpenSpec lifecycle skill**
...
- Starting work that requires frontend testing as a deliberate, documented step
...
- `templates/fe-test-strategy.md` — Frontend Test Strategy
