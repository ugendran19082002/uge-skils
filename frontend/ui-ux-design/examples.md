# UI/UX Design — Worked Examples

Realistic, end-to-end walkthroughs of the `ui-ux-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying UI/UX Design on a greenfield feature

**Context.** A team is starting new work and needs ui/ux design done properly the first time.
...
## Example 2: Applying UI/UX Design to an existing system

**Context.** An established system needs ui/ux design retrofitted to reduce risk.
