...
> **Category:** Frontend · **Skill:** `ui-ux-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires ui/ux design as a deliberate, documented step
...
- `templates/ux-spec.md` — UX Spec
- `templates/usability-test-plan.md` — Usability Test Plan
