...
> **Category:** Frontend · **Skill:** `frontend-optimization` · **OpenSpec lifecycle skill**
...
- Starting work that requires frontend optimization as a deliberate, documented step
...
- `templates/perf-budget.md` — Performance Budget
- `templates/optimization-plan.md` — Optimization Plan
