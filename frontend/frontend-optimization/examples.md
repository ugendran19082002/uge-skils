# Frontend Optimization — Worked Examples

Realistic, end-to-end walkthroughs of the `frontend-optimization` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Frontend Optimization on a greenfield feature

**Context.** A team is starting new work and needs frontend optimization done properly the first time.
...
## Example 2: Applying Frontend Optimization to an existing system

**Context.** An established system needs frontend optimization retrofitted to reduce risk.
