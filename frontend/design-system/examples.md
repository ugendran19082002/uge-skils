# Design System — Worked Examples

Realistic, end-to-end walkthroughs of the `design-system` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Design System on a greenfield feature

**Context.** A team is starting new work and needs design system done properly the first time.
...
## Example 2: Applying Design System to an existing system

**Context.** An established system needs design system retrofitted to reduce risk.
