...
> **Category:** Frontend · **Skill:** `design-system` · **OpenSpec lifecycle skill**
...
- Starting work that requires design system as a deliberate, documented step
...
- `templates/ds-governance.md` — Design System Governance
