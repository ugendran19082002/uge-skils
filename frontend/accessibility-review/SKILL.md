...
> **Category:** Frontend · **Skill:** `accessibility-review` · **OpenSpec lifecycle skill**
...
- Starting work that requires accessibility review as a deliberate, documented step
...
- `templates/a11y-audit.md` — Accessibility Audit
- `templates/vpat.md` — Conformance Statement
