# Accessibility Review — Worked Examples

Realistic, end-to-end walkthroughs of the `accessibility-review` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Accessibility Review on a greenfield feature

**Context.** A team is starting new work and needs accessibility review done properly the first time.
...
## Example 2: Applying Accessibility Review to an existing system

**Context.** An established system needs accessibility review retrofitted to reduce risk.
