# CI/CD Pipeline — Worked Examples

Realistic, end-to-end walkthroughs of the `ci-cd-pipeline` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying CI/CD Pipeline on a greenfield feature

**Context.** A team is starting new work and needs ci/cd pipeline done properly the first time.
...
## Example 2: Applying CI/CD Pipeline to an existing system

**Context.** An established system needs ci/cd pipeline retrofitted to reduce risk.
