# Authentication Design — Worked Examples

Realistic, end-to-end walkthroughs of the `authentication-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Authentication Design on a greenfield feature

**Context.** A team is starting new work and needs authentication design done properly the first time.
...
## Example 2: Applying Authentication Design to an existing system

**Context.** An established system needs authentication design retrofitted to reduce risk.
