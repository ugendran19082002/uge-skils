# Business Analysis — Worked Examples

Realistic, end-to-end walkthroughs of the `business-analysis` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Business Analysis on a greenfield feature

**Context.** A team is starting new work and needs business analysis done properly the first time.
...
## Example 2: Applying Business Analysis to an existing system

**Context.** An established system needs business analysis retrofitted to reduce risk.
