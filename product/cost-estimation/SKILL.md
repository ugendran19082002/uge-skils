...
> **Category:** Product · **Skill:** `cost-estimation` · **OpenSpec lifecycle skill**
...
- Starting work that requires cost estimation as a deliberate, documented step
...
- `templates/estimate.md` — Cost Estimate
- `templates/tco-model.md` — TCO Model
