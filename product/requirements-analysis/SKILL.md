...
> **Category:** Product · **Skill:** `requirements-analysis` · **OpenSpec lifecycle skill**
...
- Starting work that requires requirements analysis as a deliberate, documented step
...
- Requirement defect leakage to later phases
...
- `templates/srs.md` — Requirements Specification
- `templates/traceability-matrix.md` — Traceability Matrix
