# Requirements Analysis — Worked Examples

Realistic, end-to-end walkthroughs of the `requirements-analysis` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Requirements Analysis on a greenfield feature

**Context.** A team is starting new work and needs requirements analysis done properly the first time.
...
## Example 2: Applying Requirements Analysis to an existing system

**Context.** An established system needs requirements analysis retrofitted to reduce risk.
