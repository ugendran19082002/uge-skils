# Proposal Creation — Worked Examples

Realistic, end-to-end walkthroughs of the `proposal-creation` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Proposal Creation on a greenfield feature

**Context.** A team is starting new work and needs proposal creation done properly the first time.
...
## Example 2: Applying Proposal Creation to an existing system

**Context.** An established system needs proposal creation retrofitted to reduce risk.
