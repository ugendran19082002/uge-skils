...
> **Category:** Product · **Skill:** `proposal-creation` · **OpenSpec lifecycle skill**
...
- Starting work that requires proposal creation as a deliberate, documented step
...
- Win rate
- Scope/cost variance vs proposal
