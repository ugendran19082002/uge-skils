# Roadmap Planning — Worked Examples

Realistic, end-to-end walkthroughs of the `roadmap-planning` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Roadmap Planning on a greenfield feature

**Context.** A team is starting new work and needs roadmap planning done properly the first time.
...
## Example 2: Applying Roadmap Planning to an existing system

**Context.** An established system needs roadmap planning retrofitted to reduce risk.
