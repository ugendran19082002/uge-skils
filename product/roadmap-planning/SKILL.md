...
> **Category:** Product · **Skill:** `roadmap-planning` · **OpenSpec lifecycle skill**
...
- Starting work that requires roadmap planning as a deliberate, documented step
...
- % roadmap items delivering stated outcome
- Roadmap churn rate
...
- `templates/roadmap.md` — Roadmap
- `templates/prioritization.md` — Prioritization Worksheet
