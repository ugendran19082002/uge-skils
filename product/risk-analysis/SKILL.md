...
> **Category:** Product · **Skill:** `risk-analysis` · **OpenSpec lifecycle skill**
...
- Starting work that requires risk analysis as a deliberate, documented step
...
- Risks that became issues unmanaged
...
- `templates/risk-register.md` — Risk Register
- `templates/risk-matrix.md` — Risk Matrix
