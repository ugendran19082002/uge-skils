# Risk Analysis — Worked Examples

Realistic, end-to-end walkthroughs of the `risk-analysis` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Risk Analysis on a greenfield feature

**Context.** A team is starting new work and needs risk analysis done properly the first time.
...
## Example 2: Applying Risk Analysis to an existing system

**Context.** An established system needs risk analysis retrofitted to reduce risk.
