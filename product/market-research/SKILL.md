...
> **Category:** Product · **Skill:** `market-research` · **OpenSpec lifecycle skill**
...
- Starting work that requires market research as a deliberate, documented step
...
- Decisions changed by research findings
...
- `templates/market-sizing.md` — Market Sizing Model
- `templates/competitive-matrix.md` — Competitive Matrix
