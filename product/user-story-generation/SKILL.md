...
> **Category:** Product · **Skill:** `user-story-generation` · **OpenSpec lifecycle skill**
...
- Starting work that requires user story generation as a deliberate, documented step
...
- `templates/user-story.md` — User Story
- `templates/acceptance-criteria.md` — Acceptance Criteria
