# User Story Generation — Worked Examples

Realistic, end-to-end walkthroughs of the `user-story-generation` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying User Story Generation on a greenfield feature

**Context.** A team is starting new work and needs user story generation done properly the first time.
...
## Example 2: Applying User Story Generation to an existing system

**Context.** An established system needs user story generation retrofitted to reduce risk.
