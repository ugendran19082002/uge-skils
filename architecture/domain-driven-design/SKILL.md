...
> **Category:** Architecture · **Skill:** `domain-driven-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires domain-driven design as a deliberate, documented step
...
- `templates/context-map.md` — Context Map
- `templates/ubiquitous-language.md` — Ubiquitous Language Glossary
