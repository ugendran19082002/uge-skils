# Domain-Driven Design — Worked Examples

Realistic, end-to-end walkthroughs of the `domain-driven-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Domain-Driven Design on a greenfield feature

**Context.** A team is starting new work and needs domain-driven design done properly the first time.
...
## Example 2: Applying Domain-Driven Design to an existing system

**Context.** An established system needs domain-driven design retrofitted to reduce risk.
