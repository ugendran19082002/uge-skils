...
> **Category:** Architecture · **Skill:** `frontend-architecture` · **OpenSpec lifecycle skill**
...
- Starting work that requires frontend architecture as a deliberate, documented step
...
- `templates/fe-architecture.md` — Frontend Architecture
- `templates/rendering-decision.md` — Rendering Strategy Decision
