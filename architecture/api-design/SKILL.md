...
> **Category:** Architecture · **Skill:** `api-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires api design as a deliberate, documented step
...
- `templates/api-spec.md` — API Design Spec
- `templates/openapi.md` — OpenAPI Skeleton
