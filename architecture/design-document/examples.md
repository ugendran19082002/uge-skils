# Design Document — Worked Examples

Realistic, end-to-end walkthroughs of the `design-document` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Design Document on a greenfield feature

**Context.** A team is starting new work and needs design document done properly the first time.
...
## Example 2: Applying Design Document to an existing system

**Context.** An established system needs design document retrofitted to reduce risk.
