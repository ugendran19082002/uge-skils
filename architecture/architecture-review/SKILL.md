...
> **Category:** Architecture · **Skill:** `architecture-review` · **OpenSpec lifecycle skill**
...
- Starting work that requires architecture review as a deliberate, documented step
...
- `templates/review-report.md` — Architecture Review Report
- `templates/qa-scenarios.md` — Quality-Attribute Scenarios
