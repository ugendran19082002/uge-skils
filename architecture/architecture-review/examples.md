...
Realistic, end-to-end walkthroughs of the `architecture-review` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Architecture Review on a greenfield feature

**Context.** A team is starting new work and needs architecture review done properly the first time.
...
## Example 2: Applying Architecture Review to an existing system

**Context.** An established system needs architecture review retrofitted to reduce risk.
