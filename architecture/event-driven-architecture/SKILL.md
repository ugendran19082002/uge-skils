...
> **Category:** Architecture · **Skill:** `event-driven-architecture` · **OpenSpec lifecycle skill**
...
- Starting work that requires event-driven architecture as a deliberate, documented step
...
- `templates/event-catalogue.md` — Event Catalogue
- `templates/saga-design.md` — Saga Design
