...
> **Category:** Architecture · **Skill:** `backend-architecture` · **OpenSpec lifecycle skill**
...
- Starting work that requires backend architecture as a deliberate, documented step
...
- Cross-service coupling incidents
...
- `templates/be-architecture.md` — Backend Architecture
- `templates/service-map.md` — Service Map
