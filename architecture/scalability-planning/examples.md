# Scalability Planning — Worked Examples

Realistic, end-to-end walkthroughs of the `scalability-planning` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Scalability Planning on a greenfield feature

**Context.** A team is starting new work and needs scalability planning done properly the first time.
...
## Example 2: Applying Scalability Planning to an existing system

**Context.** An established system needs scalability planning retrofitted to reduce risk.
