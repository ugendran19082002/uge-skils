...
> **Category:** Architecture · **Skill:** `scalability-planning` · **OpenSpec lifecycle skill**
...
- Starting work that requires scalability planning as a deliberate, documented step
...
- `templates/scalability-plan.md` — Scalability Plan
- `templates/capacity-model.md` — Capacity Model
