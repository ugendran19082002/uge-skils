...
> **Category:** Architecture · **Skill:** `database-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires database design as a deliberate, documented step
...
- `templates/data-model.md` — Data Model & ERD
