...
> **Category:** Architecture · **Skill:** `realtime-architecture` · **OpenSpec lifecycle skill**
...
- Starting work that requires realtime architecture as a deliberate, documented step
...
- `templates/realtime-design.md` — Realtime Design
- `templates/delivery-guarantees.md` — Delivery Guarantees Plan
