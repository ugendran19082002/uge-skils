# Microservices Governance — Worked Examples

Realistic, end-to-end walkthroughs of the `microservices-governance` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Microservices Governance on a greenfield feature

**Context.** A team is starting new work and needs microservices governance done properly the first time.
...
## Example 2: Applying Microservices Governance to an existing system

**Context.** An established system needs microservices governance retrofitted to reduce risk.
