...
> **Category:** Architecture · **Skill:** `microservices-governance` · **OpenSpec lifecycle skill**
...
- Starting work that requires microservices governance as a deliberate, documented step
...
- `templates/service-standards.md` — Service Standards
- `templates/readiness-checklist.md` — Service Readiness Checklist
