# LLMOps — Worked Examples

Realistic, end-to-end walkthroughs of the `llmops` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying LLMOps on a greenfield feature

**Context.** A team is starting new work and needs llmops done properly the first time.
...
## Example 2: Applying LLMOps to an existing system

**Context.** An established system needs llmops retrofitted to reduce risk.
