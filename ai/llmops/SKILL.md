...
> **Category:** AI & Data · **Skill:** `llmops` · **OpenSpec lifecycle skill**
...
- Starting work that requires llmops as a deliberate, documented step
...
- `templates/llmops-runbook.md` — LLMOps Runbook
- `templates/monitoring-plan.md` — LLM Monitoring Plan
