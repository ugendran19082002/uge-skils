...
> **Category:** AI & Data · **Skill:** `rag-architecture` · **OpenSpec lifecycle skill**
...
- Starting work that requires rag architecture as a deliberate, documented step
...
- `templates/rag-design.md` — RAG Architecture
- `templates/eval-harness.md` — RAG Evaluation Harness
