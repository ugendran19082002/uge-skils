...
Realistic, end-to-end walkthroughs of the `prompt-engineering` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Prompt Engineering on a greenfield feature

**Context.** A team is starting new work and needs prompt engineering done properly the first time.
...
## Example 2: Applying Prompt Engineering to an existing system

**Context.** An established system needs prompt engineering retrofitted to reduce risk.
