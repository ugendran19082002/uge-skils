...
> **Category:** AI & Data · **Skill:** `prompt-engineering` · **OpenSpec lifecycle skill**
...
- Starting work that requires prompt engineering as a deliberate, documented step
...
- `templates/prompt-spec.md` — Prompt Spec
- `templates/eval-set.md` — Prompt Eval Set
