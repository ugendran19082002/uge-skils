...
> **Category:** AI & Data · **Skill:** `ai-evaluation` · **OpenSpec lifecycle skill**
...
- Starting work that requires ai evaluation as a deliberate, documented step
...
- `templates/eval-plan.md` — AI Evaluation Plan
- `templates/golden-set.md` — Golden Dataset
