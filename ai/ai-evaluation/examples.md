# AI Evaluation — Worked Examples

Realistic, end-to-end walkthroughs of the `ai-evaluation` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying AI Evaluation on a greenfield feature

**Context.** A team is starting new work and needs ai evaluation done properly the first time.
...
## Example 2: Applying AI Evaluation to an existing system

**Context.** An established system needs ai evaluation retrofitted to reduce risk.
