...
> **Category:** AI & Data · **Skill:** `ai-monitoring` · **OpenSpec lifecycle skill**
...
- Starting work that requires ai monitoring as a deliberate, documented step
...
- `templates/ai-monitoring-plan.md` — AI Monitoring Plan
- `templates/drift-alerts.md` — Drift Alert Config
