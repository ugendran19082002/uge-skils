# AI Monitoring — Worked Examples

Realistic, end-to-end walkthroughs of the `ai-monitoring` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying AI Monitoring on a greenfield feature

**Context.** A team is starting new work and needs ai monitoring done properly the first time.
...
## Example 2: Applying AI Monitoring to an existing system

**Context.** An established system needs ai monitoring retrofitted to reduce risk.
