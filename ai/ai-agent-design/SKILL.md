...
> **Category:** AI & Data · **Skill:** `ai-agent-design` · **OpenSpec lifecycle skill**
...
- Starting work that requires ai agent design as a deliberate, documented step
...
- `templates/agent-spec.md` — Agent Design Spec
- `templates/tool-contract.md` — Tool Contract
