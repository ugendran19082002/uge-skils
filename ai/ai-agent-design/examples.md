# AI Agent Design — Worked Examples

Realistic, end-to-end walkthroughs of the `ai-agent-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying AI Agent Design on a greenfield feature

**Context.** A team is starting new work and needs ai agent design done properly the first time.
...
## Example 2: Applying AI Agent Design to an existing system

**Context.** An established system needs ai agent design retrofitted to reduce risk.
