...
> **Category:** AI & Data · **Skill:** `model-selection` · **OpenSpec lifecycle skill**
...
- Starting work that requires model selection as a deliberate, documented step
...
- `templates/model-decision.md` — Model Selection Decision
- `templates/benchmark-plan.md` — Benchmark Plan
