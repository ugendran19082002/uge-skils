...
> **Category:** AI & Data · **Skill:** `model-finetuning` · **OpenSpec lifecycle skill**
...
- Starting work that requires model fine-tuning as a deliberate, documented step
...
- `templates/finetune-plan.md` — Fine-Tuning Plan
- `templates/dataset-card.md` — Dataset Card
