# Guardrails Design — Worked Examples

Realistic, end-to-end walkthroughs of the `guardrails-design` skill. Each example
follows the OpenSpec phases (Discover → Specify → Design → Validate → Deliver).

## Example 1: Applying Guardrails Design on a greenfield feature

**Context.** A team is starting new work and needs guardrails design done properly the first time.
...
## Example 2: Applying Guardrails Design to an existing system

**Context.** An established system needs guardrails design retrofitted to reduce risk.
